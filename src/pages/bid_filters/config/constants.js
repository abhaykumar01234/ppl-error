...
const SIZE_HEADING_NOTE =
  "You're opted in to receive leads to buyers in the following size categories.";

const INDUSTRIES_HEADING = 'Industries';
const INDUSTRIES_HEADING_NOTE =
  "You're opted in to receive leads to buyers in the following Industries.";

const FUNCTIONALITIES_HEADING = 'Functionalities';
const FUNCTIONALITIES_HEADING_NOTE =
  "You're opted in to receive leads to buyers who need the following applications. Some application filters include additional capabilities (often more specific software modules) that can be used for more granular filtering. However, our PPL Refund Policy only gurantees filtering at the application level.";

const DEPLOYMENT_OPTIONS_HEADING = 'Deployment Options';
const DEPLOYMENT_OPTIONS_HEADING_NOTE =
  "You're opted in to receive leads to buyers in the following deployment options.";
...
const COUNTRIES_HEADING_NOTE =
  "You're opted in to receive leads to buyers in the following countries.";
