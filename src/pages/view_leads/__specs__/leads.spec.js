...
describe('View Leads Page', () => {
  ...
  context('Lead Page Components for API success', () => {
    ...
    context('Testing Table Content', () => {
      beforeEach(() => {
        ...
        cy.intercept('GET', '/vp/api/ppl/leads/12346', { fixture: 'leads/lead_details' }).as(
          'leadDetails'
        );
      });
      ...
      it('links should point to Lead Details page', () => {
        const LEAD_ID = 12346;
        cy.get('@tableRows')
          .get('tr:nth-child(2) td:nth-child(2) > a')
          .should('have.attr', 'href')
          .and('eq', `/vp/ppl/leads/${LEAD_ID}`);
        cy.get('@tableRows')
          .get('tr:nth-child(2) td:nth-child(2) a[data-gtm="pplbidding-leads-viewleaddetails"]')
          .click();
        cy.wait('@leadDetails');
    ...
    context('Export Buttons Test', () => {
      ...
      it('Displays loader on Export CSV button click & Downloads the csv file', () => {
        cy.get("button[data-gtm='pplleads-viewleads-exportcsv']").should('be.visible').click();
      ...
      it('Displays loader on Export PDF button click & Downloads the pdf file', () => {
        cy.get("button[data-gtm='pplleads-viewleads-exportpdf']").should('be.visible').click();
  ...
  context('Lead Page Components for API fail', () => {
    ...
    it(
      "should select today's date as Start & End Date " +
